    ...
    return (
        <>
            ...
            <div className="research-areas">
                <Heading name="Algebra"/>

                <h2>Algebra, Category theory, Universal Algebras, Algebraic topology</h2>
                <h3>Prof. P.G. Romeo</h3>
                ...
                <h2>Classical algebraic K-theory, Non-commutative Algebras</h2>
                <h3>Dr. A.A. Ambily</h3>
                ...
                <Heading name="Analysis"/>
                <h2>Functional Analaysis</h2>
                ...
                <h2>Operator Theory and Operator Algebras </h2>
                <h3>Dr. Shankar P</h3>
                ...
                <h2>Operator Theory, Operator Algebras and course geometry</h2>
                <h3>Dr. Tatagatha Banerjee</h3>
                ...
                <Heading name="Discrete Mathematics"/>


                <h2>Graph Theory</h2>
                <h3>Dr. Aparna Lakshmanan S.</h3>
	            ...
	            <p>
                    My immediate future plan is to work on two areas – graph labelling and spectral graph theory. In graph labelling, I wish to focus on Leech labelling. The concept was introduced in 1975, motivated by a problem in electrical engineering. In spectral graph theory, three types of energies are well studied – energies defined from adjacency matrix, distance matrix and Laplacian matrix. My research group is looking for another variant which is directly related to a type of energy of a chemical molecule. 
                </p>

                <Heading name="Applied Mathematics"/>

                <h2>Fuzzy Mathematics, Lattice Theory, Optimization Techniques, Fractional Calculus</h2>
                <h3>Prof. Sasi Gopalan</h3>
                ...
                <h2>Representation theory and Fuzzy Mathematics</h2>
                ...
                <h2>Convex optimization problem</h2>
