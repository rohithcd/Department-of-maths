...
export let AsstProfessors = [
    ...
    {name: "Dr. V. B. Kiran Kumar", job: ranks[3], pic: [p_img6], bio: p_bio[6], qua: "MSc, PhD", publi: 13, phd: "No. of Phd Students: Awarded 1, Ongoing 4", award: null, areaOfInt: "Functional Analysis", profLink: "/people/faculty/profile=JBbkICAq", doc: pdf6},
