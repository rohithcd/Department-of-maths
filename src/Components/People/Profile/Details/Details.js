...
export let Professors = [
    ...
    {name: "Prof. P. G. Romeo", pos: "Emeritus Scientist (CSIR)", pic: [p_img1], bio: p_bio[0], qua:"MSc, PhD", publi:32, phd: "No. of Phd Students: Awarded 4 Ongoing 8", award: null, areaOfInt: "Algebra, Category theory, Algebraic topology, Universal algebras", profLink: "/people/faculty/profile=Azyq5R38",/* doc: pdf0*/},
    {name: "Prof. Ambat Vijayakumar", pos: "Emeretus Professor", pic: [p_img3], bio: p_bio[2], qua:"PhD", publi: 71, phd: "No. of Phd Students: Awarded 13", award: null, areaOfInt: "Discrete Mathematics", profLink: "/people/faculty/profile=5D7f5vjz", doc: cv_ambat},
    {name: "Prof M.N.N Namboothiri", pos: "Emeretus Professor", pic: [mnn_pic], bio: [], qua: "PhD", publi: 22, phd: "No. of Phd Students: 6", award: null, areaOfInt: "Broadly Functional Analysis, Current research topics: Spectral Analysis of Schrodinger Operators, Spectral Analysis large matrices, Approximation Theory in Operator Algebras", profLink: "/people/faculty/profile=Bb5G5mjy", /* doc: pdf2*/},
    {name: "Prof K.P. Naveenachandran", pos: "Adjunct Professor", pic: [kpn], bio: [], qua: "PhD", publi: 4, phd: null, award: null, areaOfInt: "Commutative Algebra", profLink: "/people/faculty/profile=jL54iokq", /* doc: pdf2*/}

];

export let AssocProfessors = [
    {name: "Dr. Shery Fernandez", job: "Associate Professor", pic: [p_img4], bio: p_bio[3], qua: "M.Phil, PhD", publi: 29, phd: "No. of Phd Students: Awarded 2, Ongoing 5", award: null, areaOfInt: "Representation theory, Fuzzy Mathematics", profLink: "/people/faculty/profile=6SsAl9xE", /* doc: pdf3*/},
    {name: "Dr. Aparna Lakshmanan S", job: "Associate Professor", pic: [p_img8, profile_pic1], bio: p_bio[5], qua: "PhD", publi: 29, phd: "No. of Phd Students: Awarded 4, Ongoing 5", award: "Award: Kerala State Young Scientist Award 2012", areaOfInt: "Graph Theory", profLink: "/people/faculty/profile=ZIzVik2u", doc: pdf5},
];
...
export let AsstProfessors = [
    ...
    {name: "Dr. V. B. Kiran Kumar", job: ranks[3], pic: [p_img6], bio: p_bio[6], qua: "MSc, PhD", publi: 13, phd: "No. of Phd Students: Awarded 1, Ongoing 4", award: "Kerala State Young Scientist Award 2017", areaOfInt: "Functional Analysis", profLink: "/people/faculty/profile=JBbkICAq", doc: pdf6},
    ...
    {name: "Dr. Shankar P", job: ranks[3], pic: [p_img9], bio: p_bio[8], qua: "MSc, PhD", publi: 7, phd: "No. of Phd Students: Ongoing 2", award: null, areaOfInt: "Functional analysis, Operator algebras and Operator theory", profLink: "/people/faculty/profile=16HJ4Mgh", doc: pdf8},
